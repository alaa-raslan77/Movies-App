        ...
        builder: (context, snapshot) {
          ...
          return Padding(
            ...
            child: ListView.separated(
                ...
                itemBuilder: (context, index) => snapshot.connectionState == ConnectionState.waiting?CardLoading(
                  height: 100,
                  cardLoadingTheme: CardLoadingTheme(colorOne: AppColors.colorBlack,
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children:[
                                ...
                                Image.asset("assets/images/before_adding.png"),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(category[index].releaseDate!.substring(0, category[index].releaseDate!.length.clamp(0, 4)),
                                style: GoogleFonts.inter(
