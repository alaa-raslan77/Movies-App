                    ...
                    children:[
                      GestureDetector(
                        ...
                        child: item.backdropPath == null
                            ? Image.asset("assets/images/no_image.png",fit: BoxFit.fitWidth,
                      ...
                      Padding(
                        ...
                        child: Stack(
                          children:[ GestureDetector(
                            ...
                            child:  item.backdropPath == null
                ? Image.asset("assets/images/no_image.png",width: 129,
                              height: 199,):
                            Image.network(
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.connectionState == ConnectionState.waiting) {
                                return LoadingAnimationWidget.waveDots(
                                  color: AppColors.colorGray, size: 30,
                                );
                              }
                              if (snapshot.hasError) {
                                return Text(
                  ...
                  children: [
                    ...
                    FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            return Center(child: LoadingAnimationWidget.staggeredDotsWave(
                              color: AppColors.colorGray, size: 50,
                            ));
                          }
                          if (snapshot.hasError) {
                            return Text(
